...
<html lang="en">
  ...
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../../../js/metadata/metadata.js"></script>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">                
                <ul class="nav side-menu" style="font-size:13px;">
                  ...
                  <li><a href=""><i class="fa fa-bar-chart"></i> Iniciar Análisis de Métricas</a></li>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Iniciar Análisis de Métricas <small></small> </h3>
              </div>              
            </div>
                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <div class="col-xs-6 form-group has-feedback">
                        <button class="btn-lg btn btn-success" onclick="meta.uploadURL($('#txtUrl').val());">Subir los Archivos</button><span id="subio" style="visibility: hidden;font-size:18px;color:#26B99A;"><i class="fa fa-check" style="color:#080;"></i> Archivos subidos</span>
                    </div>
                    <br />
                    <label class="control-label col-md-12 col-sm-12 col-xs-12" style="font-size:16px;text-align: left;">
                    ...
                    <div class="col-xs-12 form-group has-feedback">
                        <button class="btn-lg btn btn-success" onclick="meta.get($('#oa_id').val());">Calcular Métricas</button>
                    </div>
                    <br /><br />
                    <div id="resultsMeta" style="display:none;">
                        ...
                        <div id="rptMetricas" class="col-xs-12 form-group has-feedback" style="width:300px;height:80px;position:relative;left:-10px;">
                            <button class='btn-sm btn btn-danger' onclick="meta.rpt($('#oa_id').val());">Generar Reporte de Métricas Inconsistentes</button>
                        </div>
                    </div>
                  </div>
                </div>
