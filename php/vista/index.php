        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index" class="site_title"><i class="fa fa-paw"></i> <span>eCommerce</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">                
                <ul class="nav side-menu">
                  ...
                  <li><a href="empresa/frmWizardNewEmpresa"><i class="fa fa-magic"></i> Wizard</a></li>
                  <li><a><i class="fa fa fa-suitcase"></i> Microempresas <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> Estad&iacute;sticas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <!--<li class="disabled"><a>Pedidos <span class="label label-success pull-right">Pronto</span></a></li>
                      <li class="disabled"><a>Mensajes <span class="label label-success pull-right">Pronto</span></a></li>                      -->
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><?php echo $_SESSION['nombreUsuario'].' '.$_SESSION['apellidoUsuario'];?>
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="usuario/frmProfileUsuarioAdmin"> Perfil</a></li>
                    <li>
                      <a href="javascript:;">
