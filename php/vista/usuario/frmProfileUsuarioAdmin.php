                ...
                <div class="x_panel">                  
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <h3><?php echo $us_nombre.' '.$us_apellido;?></h3>
                      ...
                      <ul class="list-unstyled user_data">
                        ...
                        <li>
                          <i class="fa fa-bank user-profile-icon"></i> <strong>COAC: </strong><?php echo $coac->ca_descripcion;?>
                        </li>
                        <li class="m-top-xs">
                          <i class="fa fa-users user-profile-icon"></i> <strong>Usuario: </strong><?php echo $rol->ca_descripcion;?>
                        </li>
                      </ul> 
        ...
        function actualizarPerfilUsuario(){
           $.when(empresario.update(<?php echo $us_id;?>)).done(function(idUser){               
                if(idUser>0) {                    
                    ...
                    showMsj("Usuario guardado!<br />");
                }
                else showMsj("No se pudo actualizar el Perfil del Usuario. Revisa lo campos obligatorios (recuadros rojos).<br />Tal vez el Email ya existe o las Claves no coinciden.<br />");
            });
        }
