  ...
  <body class="nav-md" onload="initUsuario();">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Editar Usuario: <?php echo $us_nombre.' '.$us_apellido;?></h3>
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="row">
        ...
        <footer>
            <div class="pull-left">            
                <button id="btnGuardar" class="btn btn-success" onclick='actualizarUsuarioAdmin();'>Guardar</button>
                <button id="btnCancelar" class="btn btn-default" onclick="location.reload();">Actualizar</button>
                <button id="btnCancelar" class="btn btn-default" onclick="window.open('frmListUsuario','_self');">Volver a la Lista</button>
            </div>
    ...
    <script>
        function actualizarUsuarioAdmin(){
           $.when(empresario.update(<?php echo $us_id;?>)).done(function(idUser){
                ...
                else showMsj("No se pudo actualizar los datos del Usuario. Revisa lo campos obligatorios (recuadros rojos).<br />Tal vez el Email ya existe o las Claves no coinciden.<br />");
            });
        }
